...
<body class="nav-md">
    <div class="container body">
        <div class="main_container">
        	<jsp:include page="/WEB-INF/jsp/admin/include/common_nav_left_gentelella.jsp"></jsp:include>
            <jsp:include page="/WEB-INF/jsp/admin/include/common_nav_top_gentelella.jsp"></jsp:include>
